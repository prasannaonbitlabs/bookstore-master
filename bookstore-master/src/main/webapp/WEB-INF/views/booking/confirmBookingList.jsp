...
<div class="nav-bar">
	<div class="nav-bar-contain">
		<div class="row">
			<br>
			<div class="form-group col-xs-10">Confirmed Booking List</div>
...
<div class="content">
	<div class="row">
		...
		<table class="table table-striped">
			...
			<tbody>
				<c:forEach items="${listConfirmBooking}" var="booking"
					...
					<tr>
						...
						<td><nobr>
								<a class="btn btn-primary"
									href="/bookstore/vehicleAllocation/get/${booking.id}"> <i
									></i>Allocate
